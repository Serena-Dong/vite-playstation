...
const footerData = {
    ...
    about: ['About SIE', 'Carrers', 'Playstation Studios', 'Playstation Productions', 'Corporate'],
    support: ['Support hub', 'PlayStation Safety', 'PSN Status', 'PlayStation Repairs', 'Password reset', 'Manuals'],
    resources: ['PSN terms of service', 'PS Store cancellation policy', 'Age ratings', 'Health warning', 'Developers', 'Glossary']
}
